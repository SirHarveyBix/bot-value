...
| **Cible & Volume**              | Univers large (~700 à 1000 tickers).                                                                       | Shortlist stricte (**30 tickers maximum** — contrainte budget FMP : 30 × 5 endpoints = 150 calls nominaux + 25 retry margin = 175 hard limit sur quota 250/jour — BF-010). |
