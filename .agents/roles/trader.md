...
| Condition                                      | Exclusion                                                                                               |
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| ROE 3 ans indisponible (FMP ou yfinance IS/BS) | Exclu — ROE TTM interdit (biaisé par effets exceptionnels)                                              |
...
5. **Données fraîches** ? > 450 jours → flag périmé ; > 700 jours → exclu du ranking (exercice fiscal décalé absorbé)
